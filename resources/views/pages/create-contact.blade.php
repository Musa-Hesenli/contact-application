        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto  lg:py-0">
            ...
            <div class="w-full bg-white rounded-lg shadow dark:border mt-4 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    @endif
                    <form class="space-y-4 md:space-y-6" method="POST" enctype="multipart/form-data" action="{{ route( 'create-contact' ) }}">
                        @csrf
                        <x-input name="name" placeholder="John Doe" label="Name and Surname" type="text"></x-input>
                        <x-input name="email" placeholder="john@doe.com" label="Email" type="email"></x-input>
                        <x-input name="phone" placeholder="532323" label="Phone number" type="tel"></x-input>
                        <x-select name="category" placeholder="Choose a category" label="Contact category" :options="$categories" value="id" text="name"></x-select>
                        ...
                        <x-input name="lat" placeholder="34.43434" label="Location latitude" type="text"></x-input>
                        <x-input name="long" placeholder="34.43434" label="Location longitude" type="text"></x-input>
